        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
            <button
              type="submit"
              disabled={loading}
              className="w-full sm:flex-1 flex justify-center py-2.5 sm:py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-black bg-[#f5c518] hover:bg-[#e0b010] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#f5c518] disabled:opacity-50 disabled:cursor-not-allowed transition"
            >
            ...
            <button
              ...
              disabled={loading}
              className="text-xs sm:text-sm text-[#f5c518] hover:underline whitespace-nowrap"
            >
              Forgot password?
            </button>
          </div>
